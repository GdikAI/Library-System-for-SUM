      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) { 
          ...
          return ListTile(
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => CurrentBookPage(book: book)));
            },
            onLongPress: () {
              showDialog(
              context: context, 
              builder:(context) => AlertDialog(
                title: Text("Вы хотите удалить книгу из истории поиска?"),
                actions: [
                  TextButton(
                  onPressed: () {
